...
<h2>Form Input Kelurahan</h2><br>
    <form method="POST" action="proses-pendaftaran-kelurahan.php">
        <table width="100%" border="0">
            <tr>
                <td width="150">
                    <h5>Nama Kelurahan </h5>
                </td>
                <td><input type="text" name="nama_kelurahan" size="30" /></td>
            </tr>
            <tr>
                <td>
                    <h5>Kecamatan </h5>
           ...
           <?php
            ...
            if (isset($_GET['kelurahan'])) {
                $kecammatan = trim($_GET['kecamatan']);
  ...
  ?>
                    ...
                    <tr>
                        <td><input type="hidden" name="id_kelurahan" value="0" />
                        </td>
