			...
			<ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown01">
						...
						<li><a class="dropdown-item" href="list_kelurahan.php">Desa / Kelurahan</a></li>
					</ul>
			  </li>
...
$kelurahan = mysqli_fetch_assoc($query);
...
?>
            ...
            <form action="proses-edit-kelurahan.php" method="post">
		
        <fieldset>
    
            <input type="hidden" name="id_kelurahan" value="<?php echo $kelurahan['id_kelurahan'] ?>">	<!-- membuat inputan hidden dan nilainya adalah siswa_id -->
            <table width="100%" border="0">
            
             
            <tr>
                <td width="200">Nama Kelurahan </td>
                <td><input type="text"
                name="nama_kelurahan"
                size="40" 
                <?php echo $kelurahan['nama_kelurahan'] ?>/></td>
            </tr>
           ...
           <?php
            ...
            $query = mysqli_query($db, "SELECT * FROM kelurahan, kecamatan WHERE id_kelurahan='$id' AND kelurahan.id_kecamatan = kecamatan.id_kecamatan");
	        $data = mysqli_fetch_array($query);
            
            echo "<option value='$data[id_kecamatan]'>$data[nama_kecamatan]</option>";
            
                $query_kecamatan = mysqli_query($db, "SELECT * FROM kecamatan ORDER BY nama_kecamatan ASC");

                while ($row_kecamatan = mysqli_fetch_assoc($query_kecamatan)) {
                    echo "<option value='$row_kecamatan[id_kecamatan]'>$row_kecamatan[nama_kecamatan]</option>";
                }
