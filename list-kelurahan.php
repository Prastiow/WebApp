    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="text-center">
          <h1 class="text-capitalize mb-0 text-lg">LIST KELURAHAN</h1>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 mx-auto">
				...
				<nav>
					<a href="form-input-kelurahan.php">[+] Tambah Baru</a>
				</nav>
				...
				<tbody>
					...
					$sql = "SELECT * FROM kelurahan, kecamatan, kabupaten WHERE kelurahan.id_kecamatan=kecamatan.id_kecamatan AND kecamatan.id_kabupaten = kabupaten.id_kabupaten";
					$query = mysqli_query($db, $sql);
			
					while($kelurahan = mysqli_fetch_array($query)){
						echo "<tr>";
			
						echo "<td>".$kelurahan['nama_kelurahan']."</td>";
						echo "<td>".$kelurahan['nama_kecamatan']."</td>";
						echo "<td>".$kelurahan['nama_kabupaten']."</td>";
					   
			
						echo "<td>";
						echo "<a href='edit-kelurahan.php?id_kelurahan=".$kelurahan['id_kelurahan']."'>Edit</a> | ";
						echo "<a href='hapus-kelurahan.php?id_kelurahan=".$kelurahan['id_kelurahan']."'>Hapus</a>";
						echo "</td>";
